...
export type ComponentDemoProps = { comp: Dict; scope?: Dict; path?: string };

export const ComponentDemo = (props: ComponentDemoProps) => {
  const { comp, scope, path: propsPath } = props;
  const { name, url, preview, code: initialCode = "", rawCode } = comp;
  ...
  return (
    <LiveProvider scope={{ ...demoScope, ...(scope && scope) }} code={api.code}>
      <chakra.div
        border="solid 1px"
        rounded="lg"
      ...
      >
        ...
        <chakra.div hidden={!api.isPreviewMode}>
